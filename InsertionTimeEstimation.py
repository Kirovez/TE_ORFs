...
class LTR_InsertionTimeCalculator():
    ...
    def __init__(self, fasta_LTR_left, fasta_LTR_right):
    ...
    def run(self):
        ...
        with open("{}.ins_time".format(self.fasta_LTR_left), "w") as outfile:
...
LTR_InsertionTimeCalculator(r"D:\PycharmProjects\MossRepeatomArticle\Data\repeatome\Pp__5ltr.fas",
                            r"D:\PycharmProjects\MossRepeatomArticle\Data\repeatome\Pp__3ltr.fas")